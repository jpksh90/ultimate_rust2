...
impl Frog {
    ...
    pub fn hop(&mut self) {
        self.energy -= 1;
        info!("a Frog hopped {}", self.energy);
        ...
        if self.energy == 0 {
            ...
            warn!("flog will go to sleep since he ran out of energy");
            self.sleep();
        }
    }
...
impl Default for Frog {
    fn default() -> Self {
        ...
        trace!("default vlue energy={} sleeping={}", 5, false);
